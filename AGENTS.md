<!-- bmad:context -->
<!-- Verified 2026-08-13 against 7e2d5a6. Managed by bmad-project-context; edits inside this block are replaced on refresh. Keep anything you want preserved outside the markers. -->
...
- Product is always called **"Edupia Class"** — not "AI Class", not "UniClass". Edupia Club is a separate shared component, not a product differentiator.
